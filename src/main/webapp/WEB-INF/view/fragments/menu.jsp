...
<a id="main" href="${pageContext.servletContext.contextPath}/controller?command=main&lang=${param.get("lang")}"><fmt:message key="local.menu.faculties"/></a>
<a id="apply" href="${pageContext.servletContext.contextPath}/controller?command=apply&lang=${param.get("lang")}"><fmt:message key="local.button.apply"/></a>

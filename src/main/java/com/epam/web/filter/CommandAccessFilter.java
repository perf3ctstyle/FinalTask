...
public class CommandAccessFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        accessMap.put(UserRole.ADMIN, Arrays.asList(GET_ADMIN_MAIN, GET_APPLICATIONS_PAGE, APPROVE_APPLICATION,
                ...
                GET_REGISTERS_PAGE, DELETE_REGISTER, SAVE_ADMITTED_ABITURIENTS, DELETE_USER,
                CHANGE_IS_USER_BLOCKED));

        mutualCommands.addAll(Arrays.asList(LOGOUT, GET_FACULTY_LIST, GET_ADMITTED_ABITURIENTS, ERROR));

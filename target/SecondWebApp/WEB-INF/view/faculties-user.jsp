...
<div class="main-content-container">
    ...
    <c:forEach var="faculty" items="${facultyList}">
        <div class="faculty">
            ...
            <div class="buttons">
                <a href="${pageContext.request.contextPath}/controller?command=getFacultyPage&name=${faculty.name}" class="button about-button"><fmt:message key="local.faculty.button.about"/></a>
                <a href="${pageContext.request.contextPath}/controller?command=getApplyPage" class="button apply-button"><fmt:message key="local.button.apply"/></a>
